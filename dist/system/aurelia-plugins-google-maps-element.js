System.register(['aurelia-binding', 'aurelia-dependency-injection', 'aurelia-event-aggregator', 'aurelia-task-queue', 'aurelia-templating', './aurelia-plugins-google-maps-config'], function (_export, _context) {
  ...
  var BindingEngine, inject, EventAggregator, TaskQueue, bindable, customElement, noView, Config;
  return {
    ...
    execute: function () {
      ...
      let GoogleMaps = (_dec = customElement('aup-google-maps'), _dec2 = noView(), _dec3 = inject(Element, BindingEngine, Config, EventAggregator, TaskQueue), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class GoogleMaps {
