...
export var GoogleMaps = (_dec = customElement('aup-google-maps'), _dec2 = noView(), _dec3 = inject(Element, BindingEngine, Config, EventAggregator, TaskQueue), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = function () {
